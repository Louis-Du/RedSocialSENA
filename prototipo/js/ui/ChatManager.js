...
class ChatManager {
    ...
    generateChatListItemHTML(chat) {
        ...
        const timestamp = chat.updatedAt 
            ? new Date(chat.updatedAt.toDate()).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' })
            : '';
    ...
    generateMessageHTML(msg, currentUser) {
        ...
        const timestamp = msg.createdAt 
            ? new Date(msg.createdAt.toDate()).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' })
            : '';
