...
class FilterManager {
    ...
    setupEventListeners() {
        ...
        // Escuchar cambios en los filtros en PostState (para sincronizar entre tabs, etc)
        postState.subscribeFilters(() => {
            this.restoreFilters();
        });
    }
    ...
    async applyFilters() {
        try {
            ...
            // Guardar en PostState
            postState.setFilters(filters);

            // Obtener posts filtrados
            const filteredPosts = await postService.getFilteredPosts(filters);
    ...
    clearFilters() {
        try {
            ...
            // Limpiar filtros en PostState
            postState.clearFilters();
     ...
     */
    restoreFilters() {
        const filters = postState.getFilters();
